...
ALTER TABLE public.registros
  ADD COLUMN IF NOT EXISTS pertenece_schoenstatt boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS rama_schoenstatt text;

ALTER TABLE public.registros
  ADD CONSTRAINT rama_schoenstatt_valida
  CHECK (
    rama_schoenstatt IS NULL OR rama_schoenstatt IN (
      'Juventud Masculina',
      'Juventud Femenina',
      'Colaboradores',
      'Liga Apostólica',
...
-- Recrear la función register_if_capacity agregando los dos nuevos parámetros
CREATE OR REPLACE FUNCTION public.register_if_capacity(
  ...
  p_tratamiento_detalle text,
  p_alimentacion_especial boolean,
  p_alimentacion_detalle text,
  p_padre_nombre text,
  p_padre_telefono text,
  p_madre_nombre text,
  p_madre_telefono text,
...
BEGIN
  ...
  -- Verificar duplicados (mismo CI, año, no eliminado)
  IF EXISTS (
  ...
  -- ¿Ocupa cupo? (Hijo menor de 12 al 1-ene del año no ocupa)
  ...
  INSERT INTO public.registros (
    ...
    pertenece_schoenstatt, rama_schoenstatt
  ) VALUES (
